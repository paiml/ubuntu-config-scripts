...
```json
{
  ...
  "config_file": "~/.config/reaper/reaper.toml"
}
```
...
[
  ...
  },
  {
    ...
    "action": "kill",
    "pid": 4179152,
    "command": "/path/to/ruchyruchy/target/debug/deps/test_interp_001_parser-acfc7de6986835eb",
  ...
  },
  {
    ...
    "action": "kill",
    "pid": 627250,
    "command": "~/.cargo/bin/cargo-nextest nextest run --lib --status-level skip",
    "rule": "hung_test",
    "priority": "high",
